<?php
// source: /Users/jan/Downloads/LosGAG/app/config/config.neon 
// source: /Users/jan/Downloads/LosGAG/app/config/config.local.neon 

class Container_6bfecd5137 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'26_App_Forms_UploadFormFactory',
					'27_App_Model_PostManager',
					'28_App_Model_TeamManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Forms\UploadFormFactory' => array(
				1 => array('26_App_Forms_UploadFormFactory'),
			),
			'App\Model\PostManager' => array(1 => array('27_App_Model_PostManager')),
			'Nette\Security\IAuthenticator' => array(1 => array('28_App_Model_TeamManager')),
			'App\Model\TeamManager' => array(1 => array('28_App_Model_TeamManager')),
		...
		'services' => array(
			...
			'26_App_Forms_UploadFormFactory' => 'App\Forms\UploadFormFactory',
			'27_App_Model_PostManager' => 'App\Model\PostManager',
			'28_App_Model_TeamManager' => 'App\Model\TeamManager',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/Users/jan/Downloads/LosGAG/app',
			'wwwDir' => '/Users/jan/Downloads/LosGAG',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/Users/jan/Downloads/LosGAG/app/../temp',
		));
	}
	...
	/**
	 * @return App\Forms\UploadFormFactory
	 */
	public function createService__26_App_Forms_UploadFormFactory()
	{
		$service = new App\Forms\UploadFormFactory($this->getService('27_App_Model_PostManager'), $this->getService('security.user'));
		return $service;
	}


	/**
	 * @return App\Model\PostManager
	 */
	public function createService__27_App_Model_PostManager()
	{
	...
	/**
	 * @return App\Model\TeamManager
	 */
	public function createService__28_App_Model_TeamManager()
	{
	...
	public function createServiceApplication__3()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->factory = $this->getService('26_App_Forms_UploadFormFactory');
		$service->posts = $this->getService('27_App_Model_PostManager');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/Users/jan/Downloads/LosGAG/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/Users/jan/Downloads/LosGAG/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Users/jan/Downloads/LosGAG/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=losgag', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_6bfecd5137_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/Users/jan/Downloads/LosGAG/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('28_App_Model_TeamManager'));
...
final class Container_6bfecd5137_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_6bfecd5137 $container)
	{
